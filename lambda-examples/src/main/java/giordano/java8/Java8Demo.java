...
public class Java8Demo {
    ...
    private static void rangeExample() {
        ...
        // a range
        IntStream.range(0, 11).map(Java8Demo::factorial).forEach(System.out::println);
        System.out.println();
    }
    ...
    private static void primesExample() {
    ...
    private static void printSum(IntStream s) {
    ...
    private static void funnyExample() {
