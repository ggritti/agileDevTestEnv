package com.giordano.jersey.todo.testclient;
...
import com.giordano.jersey.todo.model.Todo;

public class MyCRUDTestClient {
	...
	private static URI getBaseURI() {
		return UriBuilder.fromUri("http://localhost:8080/crud-test").build();
	}
}